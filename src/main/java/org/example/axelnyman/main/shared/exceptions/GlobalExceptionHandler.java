...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler(BudgetSavingsNotFoundException.class)
    public ResponseEntity<Object> handleBudgetSavingsNotFoundException(BudgetSavingsNotFoundException ex) {
        Map<String, String> errorResponse = new HashMap<>();
        errorResponse.put("error", ex.getMessage());
        return ResponseEntity.status(HttpStatus.NOT_FOUND).body(errorResponse);
    }
    ...
    public ResponseEntity<Object> handleTodoListNotFoundException(TodoListNotFoundException ex) {
        Map<String, String> errorResponse = new HashMap<>();
        errorResponse.put("error", ex.getMessage());
        return ResponseEntity.status(HttpStatus.NOT_FOUND).body(errorResponse);
    }
    ...
    @ExceptionHandler(NotMostRecentBudgetException.class)
    public ResponseEntity<Object> handleNotMostRecentBudgetException(NotMostRecentBudgetException ex) {
        Map<String, String> errorResponse = new HashMap<>();
        errorResponse.put("error", ex.getMessage());
        return ResponseEntity.status(HttpStatus.BAD_REQUEST).body(errorResponse);
    }
